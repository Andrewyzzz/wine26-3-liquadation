...
\item \emph{Hardness primitive:} non-bipartite collateral-debt cycles implement NOT, and SUM/NOT generalized circuits give constant-\(\delta\) PPAD-hardness in the large-impact worst case.
\end{itemize}
